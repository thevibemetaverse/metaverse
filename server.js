...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://metaverse-simulator.vercel.app', 'https://metaverse-delta.vercel.app', 'https://*.vercel.app', 'http://localhost:5173', 'http://localhost:8080'] 
    : '*',
  methods: ['GET', 'POST']
}));
...
const io = new Server(server, {
  cors: {
    origin: process.env.NODE_ENV === 'production' 
      ? ['https://metaverse-simulator.vercel.app', 'https://metaverse-delta.vercel.app', 'https://*.vercel.app', 'http://localhost:5173'] 
      : '*',
    methods: ['GET', 'POST']
  },
  pingTimeout: 30000,
